...
var CONVERSATION_NAME = "Conversation- MaaS360"; // conversation name goes here.
var fs = require('fs');
...
// Create the service wrapper
    conversation = watson.conversation({
        ...
        , username: "b9dd4d4e-73eb-405d-b95d-e0ab5e8aed40" // Replace <username>, including "<" and ">"
        , password: "0Z3GQg4ZtnPL" // Replace <password>, including "<" and ">"
        , version_date: '2017-04-10'
        , version: 'v1'
    });
    // check if the workspace ID is specified in the environment
    conversationWorkspace = "3b19f26d-8833-4a61-85f2-0672f73c2dfd"; // Replace <workspace_id>, including "<" and ">"
